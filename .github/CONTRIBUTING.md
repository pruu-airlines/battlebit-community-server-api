# Contributing to BattleBit Community Server API
...
This bit of information is here to guide you through the process of creating a bug report for BattleBit Community Server API! Issues cannot only be used for developers to track bugs, but they can also track enhancements and tasks. The more detailed your report is, the easier it is for developers to reproduce and resolve the bug!

### Did you find a bug? :bug:

* **Ensure the bug is not coming from a customization** within your files!
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/pruu-airlines/battlebit-community-server-api/issues). If the same issue exists, feel free to leave a comment and tell us you are experiencing the issue as well and if possible add some additional or missing information!
...
* **Modifications that may affect results**: It is always best to try to reproduce your issue on a clean BattleBit Community Server API if you have lots of modifications.
...
2. Next, you will need to [fork BattleBit Community Server API](https://help.github.com/articles/fork-a-repo/#fork-an-example-repository) to your account.
...
5. Now you are ready to [create a Pull Request](https://help.github.com/articles/creating-a-pull-request/) for BattleBit Community Server API!
  * Upon creating the Pull Request, make sure you follow our [template](https://github.com/pruu-airlines/battlebit-community-server-api/blob/master/.github/PULL_REQUEST_TEMPLATE.md) and provide the required information.
...
BattleBit Community Server API Team
